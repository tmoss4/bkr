...
:   Put some nice Schema.org-Meta-Data into the video-template for better SEO. If you want to know how to use the data, have a look into the front matter of the [video]({{ site.url }}{{ site.baseurl }}/design/video/).

2015-03-30 // Version 1.2
:   Added [alert-include]({{ site.url }}{{ site.baseurl }}/documentation/#alert-embed-an-alert-in-your-content) and structured Sass-files.
...
:   Now with author-support and [Schema.org microdata](http://schema.org). Edit author(s) in `authors.yml` and use it via front matter like `author: your_author_name`. Added [Disqus-comments]({{ site.url }}{{ site.baseurl }}/design/comments/#comments) to the mix.
...
:   A new polished version, with a stronger and better color scheme. [Have a look ›]({{ site.url }}{{ site.baseurl }}/design/grid/#color-scheme-and-colors-codes). Added foundation `.scss-files` to `assets/scss/` for savety.
...
:   Better typograpyh, extended [documentation]({{ site.url }}{{ site.baseurl }}/documentation/) and little subtle css-things to make *Feeling Responsive* a little better.
...
<div id="videoModal" class="reveal-modal large" data-reveal="">
 ...
 [2]: {{ site.url }}{{ site.baseurl }}/blog/archive/
