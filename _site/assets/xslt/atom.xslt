...
<xsl:template match="/atom:feed">
	...
	<link rel="canonical" href="http://localhost:4000/bkr/assets/xslt/atom.xslt">
	...
	<meta property="og:url" content="http://localhost:4000/bkr/assets/xslt/atom.xslt">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a href="http://localhost:4000/bkr/education/">Education</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://localhost:4000/bkr/education/system-exam-results/">System &amp; Exam Results</a></li>
              ...
              <li class="has-dropdown">
                <a href="http://localhost:4000/bkr/issues/">Issues</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://localhost:4000/bkr/issues/gdp/">Gross Domestic Product (GDP)</a></li>
                      ...
                      <li><a href="http://localhost:4000/bkr/issues/human-rights/">Human Rights</a></li>
                    

                      

                      <li><a href="http://localhost:4000/bkr/issues/public-health/">Public Health</a></li>
              ...
              <li class="has-dropdown">
                <a href="http://localhost:4000/bkr/business/">Business</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://localhost:4000/bkr/business/btc-cwc/">BTC/CWC</a></li>
                    

                      

                      <li><a href="http://localhost:4000/bkr/business/water-sewage/">Water and Sewage</a></li>
                    

                      

                      <li><a href="http://localhost:4000/bkr/business/bahamar/">Baha Mar</a></li>
              ...
              <li class="has-dropdown">
                <a href="http://localhost:4000/bkr/blog/">Blog</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://localhost:4000/bkr/blog/archive/">Blog Archive</a></li>
...
<div class="alert-box warning text-center"><p>This <a href="http://en.wikipedia.org/wiki/RSS" target="_blank">Atom feed</a> is meant to be used by <a href="http://en.wikipedia.org/wiki/Template:Aggregators" target="_blank">RSS reader applications and websites</a>.</p>
</div>
...
<ul class="accordion row" data-accordion="">
    ...
    <footer id="footer-content" class="bg-grau">
        ...
        <div class="row">
          ...
          <div class="small-6 medium-3 large-3 large-offset-1 columns">
              ...
              <ul class="no-bullet shadow-black">
                  ...
                  <li >
                    <a href="http://localhost:4000/bkr/about/" title="Contact">Contact</a>
                  </li>
      ...
      <div id="subfooter">
        <nav class="row">
           <section id="subfooter-left" class="small-6 medium-3 columns credits">
            <a href="https://tmoss4.github.io/pbr/collection"><img src="http://localhost:4000/bkr/images/pbrlogo.png" alt=""></a>
          </section>

          <section id="subfooter-left" class="small-12 medium-7 columns credits">
            <p>Bahamas Knowledge Revolution is part of the <a href="http://tmoss4.github.io/pbr/collection">Paper Beats Rock Collection</a> <br/>Site created using <a href="http://jekyllrb.com/">Jekyll</a> based on the <a href="http://github.com/Phlow/feeling-responsive">Feeling Responsive</a> template</p>
          </section>

          <section id="subfooter-right" class="small-12 medium-2 columns">
